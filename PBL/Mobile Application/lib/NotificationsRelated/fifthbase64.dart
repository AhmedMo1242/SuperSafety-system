...
class fifthbase64 extends StatefulWidget {
  @override
  _fifthbase64State createState() => _fifthbase64State();
}

class _fifthbase64State extends State<fifthbase64> {
  String? base64Image;
  bool isLoading = true;
  ...
  void initState() {
    ...
    imageStream = FirebaseFirestore.instance
        .collection('Line')  //collection name
        .doc('Line') // Replace with your document ID
        .snapshots();
