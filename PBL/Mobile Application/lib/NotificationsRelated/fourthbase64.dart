...
class fourthbase64 extends StatefulWidget {
  @override
  _fourthbase64State createState() => _fourthbase64State();
}

class _fourthbase64State extends State<fourthbase64> {
  String? base64Image;
  bool isLoading = true;
  ...
  void initState() {
    ...
    imageStream = FirebaseFirestore.instance
        .collection('Vest')  //collection name
        .doc('Vest') // Replace with your document ID
        .snapshots();
