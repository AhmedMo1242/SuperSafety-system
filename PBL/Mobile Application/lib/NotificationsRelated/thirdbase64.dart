...
class thirdbase64 extends StatefulWidget {
  @override
  _thirdbase64State createState() => _thirdbase64State();
}

class _thirdbase64State extends State<thirdbase64> {
  String? base64Image;
  bool isLoading = true;
  ...
  void initState() {
    ...
    imageStream = FirebaseFirestore.instance
        .collection('Google')  //collection name
        .doc('Google') // Replace with your document ID
        .snapshots();
