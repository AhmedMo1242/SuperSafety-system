...
class firstbase64 extends StatefulWidget {
  @override
  _firstbase64State createState() => _firstbase64State();
}

class _firstbase64State extends State<firstbase64> {
  String? base64Image;
  bool isLoading = true;
  ...
  void initState() {
    ...
    imageStream = FirebaseFirestore.instance
        .collection('Helmet')  //collection name
        .doc('Helmet') // Replace with your document ID
        .snapshots();
